...
/* Binary tree ko heap batane ke liye 
stp1- Heap should be  complete binary tree
a) complete binary tree ke liye ya toh parent ke dono child hone chaiye ya fir left child hona chaiye
stp2-max heap property satisfy krna chahiye ie
*/
